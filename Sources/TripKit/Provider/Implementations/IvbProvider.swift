...
public class IvbProvider: AbstractHafasClientInterfaceProvider {
    ...
    public init(apiAuthorization: [String: Any]) {
        ...
        styles = [
            ...
            "T6": LineStyle(shape: .rounded, backgroundColor: LineStyle.rgb(10, 109, 56), foregroundColor: LineStyle.white),
            "TSTB": LineStyle(shape: .rounded, backgroundColor: LineStyle.rgb(96, 15, 23), foregroundColor: LineStyle.white),
            "BN1": LineStyle(shape: .rounded, backgroundColor: LineStyle.rgb(29, 49, 86), foregroundColor: LineStyle.white),
            "BN2": LineStyle(shape: .rounded, backgroundColor: LineStyle.rgb(29, 49, 86), foregroundColor: LineStyle.white),
            "BN3": LineStyle(shape: .rounded, backgroundColor: LineStyle.rgb(29, 49, 86), foregroundColor: LineStyle.white),
            "BN7": LineStyle(shape: .rounded, backgroundColor: LineStyle.rgb(29, 49, 86), foregroundColor: LineStyle.white),
            "BN8": LineStyle(shape: .rounded, backgroundColor: LineStyle.rgb(29, 49, 86), foregroundColor: LineStyle.white),
