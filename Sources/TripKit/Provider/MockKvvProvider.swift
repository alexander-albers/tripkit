...
public class MockKvvProvider: AbstractEfaWebProvider {
    ...
    public override func queryTrips(from: Location, via: Location?, to: Location, date: Date, departure: Bool, tripOptions: TripOptions, completion: @escaping (HttpRequest, QueryTripsResult) -> Void) -> AsyncRequest {
        ...
        let trip1 = Trip(id: "", from: from, to: to, legs: [PublicLeg(line: createLine(.suburbanTrain, "S2"), destination: nil, departure: createStop("Kronenplatz (Kaiserstraße)", createTime(9, 40)), arrival: createStop("Europaplatz (Kaiserstraße)", createTime(9, 46)), intermediateStops: createIntermediates(createTime(9, 40)), message: nil, path: [], journeyContext: nil, loadFactor: nil)], fares: fares)
        let trip2 = Trip(id: "", from: from, to: to, legs: [PublicLeg(line: createLine(.suburbanTrain, "S5"), destination: nil, departure: createStop("Kronenplatz (Kaiserstraße)", createTime(9, 42)), arrival: createStop("Europaplatz (Kaiserstraße)", createTime(9, 48)), intermediateStops: createIntermediates(createTime(9, 42)), message: nil, path: [], journeyContext: nil, loadFactor: nil)], fares: fares)
        let trip3 = Trip(id: "", from: from, to: to, legs: [PublicLeg(line: createLine(.suburbanTrain, "S1"), destination: nil, departure: createStop("Kronenplatz (Kaiserstraße)", createTime(9, 43)), arrival: createStop("Europaplatz (Kaiserstraße)", createTime(9, 49)), intermediateStops: createIntermediates(createTime(9, 43)), message: nil, path: [], journeyContext: nil, loadFactor: nil)], fares: fares)
        let trip4 = Trip(id: "", from: from, to: to, legs: [PublicLeg(line: createLine(.tram, "1"), destination: createStation("Oberreut"), departure: createStop("Kronenplatz (Kaiserstraße)", createTime(9, 44)), arrival: createStop("Europaplatz (Kaiserstraße)", createTime(9, 50)), intermediateStops: createIntermediates(createTime(9, 44)), message: nil, path: [], journeyContext: nil, loadFactor: nil)], fares: fares)
        let trip5 = Trip(id: "", from: from, to: to, legs: [PublicLeg(line: createLine(.tram, "4"), destination: createStation("Tivoli"), departure: createStop("Kronenplatz (Kaiserstraße)", createTime(9, 46)), arrival: createStop("Europaplatz (Kaiserstraße)", createTime(9, 52)), intermediateStops: createIntermediates(createTime(9, 46)), message: nil, path: [], journeyContext: nil, loadFactor: nil)], fares: fares)
        let trip6 = Trip(id: "", from: from, to: to, legs: [PublicLeg(line: createLine(.suburbanTrain, "S2"), destination: nil, departure: createStop("Kronenplatz (Kaiserstraße)", createTime(9, 48)), arrival: createStop("Europaplatz (Kaiserstraße)", createTime(9, 54)), intermediateStops: createIntermediates(createTime(9, 48)), message: nil, path: [], journeyContext: nil, loadFactor: nil)], fares: fares)
        let trip7 = Trip(id: "", from: from, to: to, legs: [PublicLeg(line: createLine(.suburbanTrain, "S5"), destination: createStation("Rheinbergstraße"), departure: createStop("Kronenplatz (Kaiserstraße)", createTime(9, 52)), arrival: createStop("Europaplatz (Kaiserstraße)", createTime(9, 58)), intermediateStops: createIntermediates(createTime(9, 52)), message: nil, path: [], journeyContext: nil, loadFactor: nil)], fares: fares)
        ...
        let trip10 = Trip(id: "", from: from, to: to, legs: [PublicLeg(line: createLine(.suburbanTrain, "S2"), destination: nil, departure: createStop("Kronenplatz (Kaiserstraße)", createTime(9, 58)), arrival: createStop("Europaplatz (Kaiserstraße)", createTime(10, 4)), intermediateStops: createIntermediates(createTime(9, 58)), message: nil, path: [], journeyContext: nil, loadFactor: nil)], fares: fares)
        let trip11 = Trip(id: "", from: from, to: to, legs: [PublicLeg(line: createLine(.suburbanTrain, "S52"), destination: nil, departure: createStop("Kronenplatz (Kaiserstraße)", createTime(10, 2)), arrival: createStop("Europaplatz (Kaiserstraße)", createTime(10, 8)), intermediateStops: createIntermediates(createTime(10, 2)), message: nil, path: [], journeyContext: nil, loadFactor: nil)], fares: fares)
        let trip12 = Trip(id: "", from: from, to: to, legs: [PublicLeg(line: createLine(.tram, "1"), destination: nil, departure: createStop("Kronenplatz (Kaiserstraße)", createTime(10, 4)), arrival: createStop("Europaplatz (Kaiserstraße)", createTime(10, 10)), intermediateStops: createIntermediates(createTime(10, 4)), message: nil, path: [], journeyContext: nil, loadFactor: nil)], fares: fares)
